                ...
                <ContentTemplate>
                    <div class="col-md-12">
                        <div style="overflow: visible;" class="table-responsive">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=MONSTER\SQLEXPRESS;Initial Catalog=WebAutomation;Integrated Security=True;MultipleActiveResultSets=True;Application Name=EntityFramework" DeleteCommand="DELETE FROM [Cariler] WHERE [CariID] = @CariID" InsertCommand="INSERT INTO [Cariler] ([CariAd], [CariSoyad], [CariSehir], [CariMail], [Durum]) VALUES (@CariAd, @CariSoyad, @CariSehir, @CariMail, @Durum)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [Cariler] where [Durum]='True'" UpdateCommand="UPDATE [Cariler] SET [CariAd] = @CariAd, [CariSoyad] = @CariSoyad, [CariSehir] = @CariSehir, [CariMail] = @CariMail, [Durum] = @Durum WHERE [CariID] = @CariID">
                                <DeleteParameters>
